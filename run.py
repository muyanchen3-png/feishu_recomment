...
# Get Config File
parser.add_argument('casevo-example-main\casevo-example-main\election_example\case_lite.json', metavar='config_file', type=str,
                   help='The config file for the sim')
parser.add_argument('6', metavar='round_num', type=int,
                   help='The round number of the sim')

args = parser.parse_args(['./case_lite.json', '6'])  # 手动指定参数值
